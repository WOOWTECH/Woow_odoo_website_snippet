...
> **📸 截圖說明：** 本手冊中的截圖參考路徑指向預期的操作畫面。部分截圖已收錄於 [截圖集](../../docs/SCREENSHOTS.md)，其餘為操作情境示意，將於未來版本補充。
...
![設定完成後的 Stat Card，顯示大數字和說明文字](../../docs/screenshots/demo_stat_cards.png)
...
![Stat Card 的 Progress Bar 樣式，顯示數字、進度條和百分比](../../docs/screenshots/showcase_stat_cards.png)
...
![設定完成的 Bar Chart，顯示各分類的銷售金額](../../docs/screenshots/showcase_charts.png)
...
![設定完成的 Data Table，顯示搜尋框、可排序的欄位標題、表格資料和翻頁按鈕](../../docs/screenshots/showcase_data_table.png)
...
![Dynamic Content 使用 Card 版型顯示聯絡人卡片牆](../../docs/screenshots/showcase_dynamic_content.png)
...
**Card（卡片）**
![Card 版型：方形卡片排列，每張有圖片、標題和說明文字](../../docs/screenshots/demo_dynamic_content_cards.png)

**List（清單）**
![List 版型：每行一筆資料，左邊圓形頭像，右邊文字資訊](../../docs/screenshots/demo_dynamic_content_list.png)
...
![Bar Chart 範例：垂直的彩色長條](../../docs/screenshots/showcase_charts.png)
...
![Line Chart 範例：平滑的折線連接各數據點](../../docs/screenshots/demo_charts.png)
...
![Pie Chart 範例：分成不同顏色扇形的圓形](../../docs/screenshots/showcase_charts.png)
...
![Doughnut Chart 範例：中間挖空的圓餅圖](../../docs/screenshots/demo_charts.png)
...
![Radar Chart 範例：蜘蛛網狀的多軸圖形](../../docs/screenshots/showcase_charts_2.png)
...
![Polar Area Chart 範例：從圓心向外展開的不同大小扇形](../../docs/screenshots/showcase_charts_2.png)
...
![更新模組列表的操作位置](../../docs/screenshots/apps_modules.png)
...
![搜尋到 WoOW Snippet Builder 模組，點擊安裝](../../docs/screenshots/apps_modules.png)
...
![模組升級操作位置](../../docs/screenshots/apps_modules.png)
